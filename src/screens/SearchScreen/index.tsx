...
const  Dosearch=()=>{
 ...
 { ks.DrugStoreProductsFilter({
  ...
  const searchResultsCards = ({item, index}: any) => {
    ...
    <TouchableOpacity
      ...
      <FastImage
        ...
        source={
          item.ImageName
            ? {  uri: 'http://talabeety.com/content/products/' + item.ImageName + '_1920x1280.jpg',}
  ...
  return (
    ...
    {!loading?  <View style={{width: '100%', flex: 1,justifyContent:'center',alignItems:'center',left:5}}>
      ...
      {dataSearch.length>0?  <FlatList
        ...
        />:
        <View style={{width: '100%', flex: 1,justifyContent:'center',alignItems:'center',left:5}}>
        <Text style={{
          fontSize:20,
        }}>{Languages.NoProductsHere}</Text>
        </View>
        }
